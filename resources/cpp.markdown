...
The compilation of a C++ program consists of two stages:
...
Both B and C inherit from A and thus contain A's member variables.
...
-   **LLVM DenseMap** is an unsorted alternative to the STL map.
